<template>
  <div ref="menuRef" class="id-dropdown-menu-wrapper">
    <div @click="toggle">
      <slot name="trigger" />
    </div>
    <Transition name="menu-pop">
      <div v-if="isOpen" :class="['dropdown-menu', `align-${align}`, `size-${size}`, `variant-${variant}`]" role="menu">
        <div
          v-for="(item, idx) in items"
          :key="idx"
          :class="['menu-item', { 'is-danger': item.danger, 'is-separator': item.separator }]"
